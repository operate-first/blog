...
description: Chaos Engineering has never been more important to ensure the best user experience.
tags:
...
- Cloudflare degraded performance and limited API availability [Source](https://blog.cloudflare.com/a-byzantine-failure-in-the-real-world/)
...
- Facebook services outage for 6 hours due to network failures [Source](https://engineering.fb.com/2021/10/04/networking-traffic/outage/)
...
- Netflix Outage on a Saturday Night [Source](https://www.express.co.uk/life-style/science-technology/1516749/Netflix-down-error-watch-online-network-offline-app)
...
- Alerts with appropriate severity
  ...
  - Alerts should have proper severity, description, notification policy, escalation policy, and SOP in order to reduce MTTR for responding SRE or Ops resources. Detailed information on the alerts consistency can be found [here](https://github.com/openshift/enhancements/blob/master/enhancements/monitoring/alerting-consistency.md).
